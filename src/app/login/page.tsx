        ...
        <div className="relative mt-12 max-w-xl rounded-3xl border border-slate-700 bg-[#0c1118] p-5 shadow-2xl">
          <div className="flex items-center gap-4">
            <div className="relative h-16 w-16 overflow-hidden rounded-full border-2 border-violet-500">
              <Image src="/avatar/mentor.png" alt="Mentor" fill className="object-cover" />
            </div>
            <div>
          ...
          <div className="mt-5 grid grid-cols-3 gap-3 text-center text-xs">
            <div className="rounded-xl bg-white/[.03] p-3"><strong className="block text-lg">12</strong>Apps</div>
            <div className="rounded-xl bg-white/[.03] p-3"><strong className="block text-lg">4</strong>Interviews</div>
            <div className="rounded-xl bg-white/[.03] p-3"><strong className="block text-lg">73</strong>Momentum</div>
          </div>
        </div>
      </section>
      ...
      <section className="flex items-center justify-center px-5 py-12">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <Link href={ready ? "/dashboard" : "#"} className={`block rounded-xl px-5 py-3.5 text-center text-sm font-bold ${ready ? "bg-violet-600 text-white hover:bg-violet-500" : "bg-slate-800 text-slate-500"}`}>
              Sign in
            </Link>
          </form>
